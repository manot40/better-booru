...
const post = t.Object({
  ...
  pixiv_id: t.Optional(t.Nullable(t.Number())),
  parent_id: t.Optional(t.Nullable(t.Number())),
  has_notes: t.Boolean(),
  created_at: t.Optional(t.Nullable(t.Union([t.String(), t.Date()]))),
  width: t.Number(),
  height: t.Number(),
  file_url: t.String(),
  file_ext: t.String(),
  sample_url: t.Optional(t.Nullable(t.String())),
  sample_width: t.Optional(t.Nullable(t.Number())),
  sample_height: t.Optional(t.Nullable(t.Number())),
  preview_url: t.Optional(t.Nullable(t.String())),
  preview_width: t.Optional(t.Nullable(t.Number())),
  preview_height: t.Optional(t.Nullable(t.Number())),
});
